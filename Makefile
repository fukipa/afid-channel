...
am_afid_OBJECTS = DeallocateVariables.$(OBJEXT) \
	...
	factorize.$(OBJEXT) ReadFlowField.$(OBJEXT) \
	HdfReadContinua.$(OBJEXT)
afid_OBJECTS = $(am_afid_OBJECTS)
am__DEPENDENCIES_1 =
afid_DEPENDENCIES = $(am__DEPENDENCIES_1) $(am__DEPENDENCIES_1) \
...
am__v_FCLD_1 = 
SOURCES = $(afid_SOURCES)
DIST_SOURCES = $(afid_SOURCES)
...
ACLOCAL = ${SHELL} /home/am13d022/afid/afid-1.1/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 1
AUTOCONF = ${SHELL} /home/am13d022/afid/afid-1.1/missing autoconf
AUTOHEADER = ${SHELL} /home/am13d022/afid/afid-1.1/missing autoheader
AUTOMAKE = ${SHELL} /home/am13d022/afid/afid-1.1/missing automake-1.13
AWK = gawk
BLAS_LIBS = -L/opt/intel/compilers_and_libraries_2017.2.174/linux/mkl/lib/intel64 -lmkl_intel_lp64 -lmkl_sequential -lmkl_core -lpthread
CC = gcc
...
LAPACK_LIBS = 
LDFLAGS =  -L /usr/local/hdf5-1.8.15/lib  
LIBOBJS = 
LIBS = 
LTLIBOBJS = 
MAKEINFO = ${SHELL} /home/am13d022/afid/afid-1.1/missing makeinfo
MKDIR_P = /usr/bin/mkdir -p
MPIFC = mpiifort
OBJEXT = o
PACKAGE = afid
PACKAGE_BUGREPORT = r.j.a.m.stevens@utwente.nl
PACKAGE_NAME = AFiD
PACKAGE_STRING = AFiD 1.1
...
STRIP = 
VERSION = 1.1
abs_builddir = /home/am13d022/afid/afid-1.1
abs_srcdir = /home/am13d022/afid/afid-1.1
abs_top_builddir = /home/am13d022/afid/afid-1.1
abs_top_srcdir = /home/am13d022/afid/afid-1.1
ac_ct_CC = gcc
ac_ct_FC = 
ac_ct_MPIFC = mpiifort
ac_empty = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /home/am13d022/afid/afid-1.1/install-sh
...
afid$(EXEEXT): $(afid_OBJECTS) $(afid_DEPENDENCIES) $(EXTRA_afid_DEPENDENCIES) 
	@rm -f afid$(EXEEXT)
	$(AM_V_FCLD)$(FCLINK) $(afid_OBJECTS) $(afid_LDADD) $(LIBS)
