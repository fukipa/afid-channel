...
!-------------------------------------------------
      ...
      call AllocateReal2DArray(ac3sk,1,2,1,nx)

!-------------------------------------------------
! Arrays for slip boundary conditions    
!-------------------------------------------------

      call AllocateInt2DArray(slipbp,1,ny,1,nz)
      call AllocateInt2DArray(sliptp,1,ny,1,nz)
